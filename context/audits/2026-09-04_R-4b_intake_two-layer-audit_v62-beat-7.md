...
- **Row 33's entity→device mapping — WRITTEN at v63 beat 2 (2026-09-05), derived at the records and verified by the hub at the bytes (Nick's 09-04 verbatim stays lost, not reconstructed):** `01M19RHWXYZYJMM26SX0E41HXN` = the SNZB-04P contact sensor's entity (device `0x449FDAFFFE688F57`, deviceId `01M19RHWWZXKD4MWM66KAW8MSR` — the R-4 record `:131`; this record `:203`); `01M19XN7NNQQ8S3JJF09T6YKKY` = the SNZB-03P motion entity (`0xF044D3FFFE9C78D7` — R-4 `:132`; this record `:199`). The §8 flap (`:457` UNAVAILABLE at 18:08:26Z → `:664` AVAILABLE) is therefore the contact sensor's — a sleepy battery device; the freshness-window inference is recorded as an inference (the docket Row 33).
