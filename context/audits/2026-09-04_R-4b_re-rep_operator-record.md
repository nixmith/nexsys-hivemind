...
**Post-audit correction (v62 beat 8, 2026-09-04 ~16:52 CT; Nick's word):** the router-parented sleepy device at `nwk=0x15ac` (§6, the miss arm) is the **SNZB-02P `0xF044D3FFFED2A201`** by Nick's own device mapping — the audit's by-cluster attribution (0x0402/0x0405 → the temp/humidity profile) stands corrected to the identity. The SNZB-03P is ADOPTED on this card, so its frames never reach the unknown-sender arm; the ACT 2 wave's evidence lives on this card's journal — read at its next power-on. `C-002: STANDS` (Nick, 09-04).
