...
**Done-when:** FOUR ⏺ pastes are in the hub's hands — Block-0 floor, Block-2 boot glance + `[PASS]`, Block-3 H4 rep, Block-4 A4 rep. ⏺ EVERY block, either way — a FAIL paste is a finding, not a failure.
