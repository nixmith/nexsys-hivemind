...
# ROTATED 2026-06-11 (hygiene pass, M6.2-return session) — legacy M3-era sections (Current Task / Phase 3 WU Status / Design Doc Status / Outstanding Coding Instructions / Unresolved Deviations / Next Tasks / Research Pipeline Status) + the 2026-05-18..22 records formerly below Open Risks; completes the 2026-06-10 ROTATION MARKER in `context/handoff/pm-handoff.md`
...
| M3.5b | `08d0136` | 2026-05-19 retroactive | StateProjection Production Persistence — `SqliteStateStore` + `SqliteDeadLetterStore` + `Che
