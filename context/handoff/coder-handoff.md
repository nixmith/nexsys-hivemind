...
**Status:** **OPEN — M4.0b-3 (AMD-51) build gate DEFERRED to Nick (see subsection below).** Prior gates all RESOLVED: **M4.B3 (AMD-47)** GREEN and **COMMITTED `60b4185`** (2026-05-30); **M4.0b-2** (AMD-50) GREEN `7610296`; **M4.0b-1** GREEN `cf1a97e`; **M4.0a + D-1** RESOLVED (`a441fdf`); all M3.7 gates RESOLVED 2026-05-27.
