...
**Last updated:** 2026-05-30 (**M4.B3 COMMITTED `60b4185` — WUCP Phase 2 closed.** AMD-47 AttributeValue expansion + build GREEN both gates; device-model MODULE_CONTEXT updated incl. AMD-47-INV-01..05 in the Constraints table + the three stale JSR-385 notes retired. **Research 4 FULLY RESOLVED** (DQ-1/2/3/5, v4 addendum — unblocks M7/M8 automation). Next forward WU = **M4.0b-3**. Prior: P4r AMD-47 RATIFIED; M4.0b-2 COMPLETE `7610296`.)
