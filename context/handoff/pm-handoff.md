...
state-type: current
status: CURRENT
last-verified: 2026-05-31 — M4.0b-5 (AMD-53 timestamp-model unifier) COMPLETE + COMMITTED `c99b425`; PM WUCP Phase 2 → APPROVE; `projectionVersion`=5; watermark AMD-53; deferred build gate RESOLVED (GREEN); Workstream A complete (typed end-to-end AND event-time-deterministic). Prior: M4.0b-4b `72596cb`; M4.0b-4a `971cfa1`.
-->
