...
**CURRENT (2026-05-31): AMD-52 (typed `StateChangedEvent` payload) AUTHORED + RATIFIED — doc-only, no code (HEAD `98f705b`).** Watermark **AMD-52**; AMD-52-INV-01..07 registered (Architecture_Invariants §22); Doc 01/03/04 currency. **Next forward WU = the M4.0b-4 coding instruction** (PM Mode-3, fresh session) — UNBLOCKED (String-payload freeze lifted), milestone id confirmed. See the top "This Session" entry for the full record. The entries below are the prior chain (M4.0b-3/AMD-51, M4.B3/AMD-47, M4.0b-2/AMD-50), retained for traceability.
