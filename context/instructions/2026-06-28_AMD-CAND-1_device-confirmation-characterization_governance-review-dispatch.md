...
status: RATIFIED as **AMD-97** 2026-07-01 (Nick co-signed at the v13 consolidated governance pass) + FOLDED same-day — Doc 08 §3.6 `confirmation[]` (8 fields, enum degradeRule, E5 taxonomy split, measured Wave-1 values) + Doc 02 §3.8 confirmability override + AMD-97-INV-01 (§51) + the Doc 16 §4 V1-wire-subset note. Numbered 97 because AMD-96 was already allocated (the review's numbering flag). Amendment: homesynapse-core-docs/design/amendments/AMD-97_Device-Confirmation-Characterization.md. Every review edit was independently re-derived from the Locked text by the v13 hub before fold. **M9 is UNBLOCKED.** PRIOR: READY — authored 2026-06-28 by the v11 hub, reconciling the Stream-B research return.
