...
status: STAGED 2026-06-28 by the v11 hub, from the Stream-B research return §6 (AMD-CAND-2/3). Hub recommendations: AMD-CAND-2 = scope to white/CT for V1 (option A); AMD-CAND-3 = Kelvin-canonical-at-ingestion (conform Doc 08 to Doc 02). Apply on Nick's word OR bundle into the AMD-CAND-1 review pass.
