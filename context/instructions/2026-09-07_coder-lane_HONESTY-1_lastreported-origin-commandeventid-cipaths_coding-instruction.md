...
status: ISSUE-READY (v67 beat 4, Mon 2026-09-07; instrument 2026-09-07T23:5xZ). baseline: core `39c8dd3` (F-R4-1b landed; porcelain 0 at authoring). Dispatches on Nick's paste after `PELTON: sent` (the core slot is free; TR-1 is read-only and off the core tree — two lanes under the cap).
-->
