...
status: PART A DISPATCH-READY (the bench is idle; P-1 landed `1201368`) · PART B CHARTERED — the packet is cut on `R5: <day> <hh:mm>`, after H8-a's slot, through the gate. Authored v73 beat 4 (Sun 2026-09-13 ~15:2x CT; instrument 2026-09-13T20:24:38Z) from the R-4c record §10 + §14, its audit §5–§6, the P-1 audit §3 (the six rulings) and the P-1 design doc §4; every cite read at bench `1201368`.
-->
