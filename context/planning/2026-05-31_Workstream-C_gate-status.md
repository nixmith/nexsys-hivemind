...
>
> **✅ C BRIEFED — 2026-06-05 (this note is now historical).** B-S2 landed `e76b925` (Workstream B COMPLETE); NQ-3/4 FINAL against the 12-/4-component shapes. The **integration AMD block is AUTHORED as AMD-54..64** (eleven integers — the REC-41 hooks-vs-schema split resolved as two, per P2 §8.1; REC-49 stays rejected, REC-52 → M9): `homesynapse-core-docs/design/amendments/AMD-54..AMD-64`, all PROPOSED. **Gate B discharged at the masthead level** — Doc-05 carries a currency note pointing at the block; body-fold at ratification mechanics. DOCS-Project review prompt: `context/instructions/2026-06-05_AMD-54-64_DOCS_Project_Review_Prompt.md` (carries review-flags R1–R7, incl. the Research-6-return fidelity diffs for the HealthDetail values and REC-44 permit names). Gated M4.C coding instruction drafted: `context/coding-instructions/M4.C_Integration_API_Freeze.md` (issue-gated on ratification). Successor tracking: pm-handoff + the M4.C backlog row.
