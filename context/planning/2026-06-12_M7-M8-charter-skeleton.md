...
|---|---|---|
| 1 | **M7 entry-gate AMD block RATIFIED** — the AMD-66..71 pattern: Research-4 re-anchored RECs (W0 §5) + R14 M7-OBLIGATION rows → one PROPOSED block → DOCS review → Nick ratifies. Real AMD numbers assign-at-milestone (P2 rule; the Research-4 "AMD-48..52" labels were placeholders) | ✅ **CLOSED 2026-06-12 — AMD-88..93 RATIFIED** (bundled DOCS review RATIFY-WITH-EDITS/AS-IS, all edits folded; return `context/audits/2026-06-12_AMD-88-93_C8-C9_DOCS_Review_Return.md`; invariants §42–§47 registered, index 163/47; watermark 87→93; AMD-04 SUPERSEDED) |
| 2 | **B2 C8 `actorRef` RATIFIED** (automations stamp `AutomationId`) — direct M7 contract input | ✅ **CLOSED 2026-06-12 — C8 + C9 RATIFIED in the same bundle** (EC8-1 Glossary supersession + EC8-2 origin-consistency rule folded; coupling SAFE-TOGETHER verified) |
