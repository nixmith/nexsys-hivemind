...
| Gate | Owner | Status |
|---|---|---|
| Doc 15 §6 currency amendment (rotate-DEK-on-restore binding; "rotate = additive new DEK version, retain priors" per Track-3 F6; high-water-mark → cross-check) | Nick | **RULED 2026-06-18 (A4); AMD-94 AUTHORED PROPOSED 2026-06-19 (PM).** AMD `homesynapse-core-docs/design/amendments/AMD-94_Doc15-sec6_*.md` + DOCS-review prompt `context/handoff/2026-06-19_AMD-94_DOCS-Project_review_prompt.md` (both dispatch-ready). Residual: DOCS review → Nick ratify. Doc 15 is Locked, no silent edit; watermark stays AMD-93 until ratify. Decision-gate CLOSED; ratification pending. |
