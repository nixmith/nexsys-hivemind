...
state-type: current
status: CURRENT
last-verified: 2026-05-31 against HEAD `c99b425` — M4.0b-5 (AMD-53 timestamp-model unifier) DONE `c99b425`, PM Phase 2 reviewed → APPROVE, `projectionVersion`=5, **Workstream A complete (typed end-to-end AND event-time-deterministic)**. Prior this chain: M4.0b-4b (AMD-52 typed `StateChangedEvent` payload) DONE `72596cb`; M4.0b-4a (AttributeValue relocation → `com.homesynapse.value`) DONE `971cfa1`; M4.0b-3 (AMD-51) DONE `98f705b`.
-->
