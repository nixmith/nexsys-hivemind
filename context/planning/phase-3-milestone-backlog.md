...
state-type: current
status: CURRENT
last-verified: 2026-06-04 against HEAD `e73e199` — M4.B-S1 (AMD-44 Stage 1: Floor/`FloorId`/Area + `Set<HardwareIdentifier>`) DONE `e73e199`, PM Phase 2 → APPROVE. Workstream B Stage 1 DONE; next = M4.B-S2 (EntityRole). Prior this chain: M4.0b-5 (AMD-53) DONE `c99b425` (`projectionVersion`=5, **Workstream A complete — typed end-to-end AND event-time-deterministic**); M4.0b-4b (AMD-52) DONE `72596cb`; M4.0b-4a (relocation) DONE `971cfa1`; M4.0b-3 (AMD-51) DONE `98f705b`.
-->
