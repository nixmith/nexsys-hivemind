...
| `nexsys-skills` | (verify at need) | Other skill sources — `orchestrators/nexsys-frontend/` is the frontend skill's writable source |
| `_scratch/`, `_archive/`, `skills-initiative/` | unversioned | Commit-message staging (`git commit -F`); parked material |
