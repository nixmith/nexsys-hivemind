...
status: CURRENT
last-verified: 2026-06-05 against `8ef9e9f` — **M4 COMPLETE** (Workstreams A+B+C; integration-api freeze AMD-54..64; watermark AMD-64; `projectionVersion` 5; new `core/value-model` leaf module holding the relocated `AttributeValue` hierarchy). Prior spine state: `98f705b` (M4.0b-3, watermark AMD-51).
-->
...
**Last verified against:** `homesynapse-core` **`8ef9e9f` (M4 COMPLETE)** on 2026-06-05. Workstreams A+B+C done; **AMD-44..64 ratified, watermark AMD-64**, `projectionVersion` 5; new `core/value-model` leaf (relocated `AttributeValue`); integration-api frozen 22→40; AMD-65 (Expectation codec) QUEUED BLOCKING-for-M9; 133 invariants across 32 categories.
