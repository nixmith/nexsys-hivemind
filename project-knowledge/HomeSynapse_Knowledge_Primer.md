...
**Last verified against:** `homesynapse-core` **`e5ea76f`** (substantive **`7c73c91`** = M6.2) on 2026-06-13. M4 + M5-A + **M6.1/M6.4/M6.2 shipped** (M6.3 triple-gated — the last M6 piece); **Doc 15 LOCKED**; AMD-86/87 + the AMD-66..71 block RATIFIED; watermark **AMD-87 on disk**; `projectionVersion` 5; event pins **55/24/36**; **152 invariants across 41 identifier categories** (regenerated 2026-06-09; 11 AMD-88..93 candidates PENDING). **AMD-88..93 (M7 automation block) + B2 C8/C9 are PROPOSED — bundled DOCS review READY TO DISPATCH 2026-06-13.** Next: Nick dispatches the bundle → ratification mechanics (watermark→93) → M7.1 on a green 5-row entry-gate.
