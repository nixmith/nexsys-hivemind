...
**Last verified against:** `homesynapse-core` M4.0b-2 closeout commit `7610296` on `2026-05-29`. M4 Workstream A substantially COMPLETE (M4.0a/M4.0b-1/M4.0b-2); derivation/advancer are real (`ProductionDerivationRule`/`DispatchingProjectionAdvancer` in state-store), `projectionVersion`=2, AMD-44/45/50 ratified (watermark AMD-50), P2 ratified. Next: M4.B3 → M4.0b-3.
